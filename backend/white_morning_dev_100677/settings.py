"""
Django settings for white_morning_dev_100677 project.
...
ROOT_URLCONF = 'white_morning_dev_100677.urls'
...
WSGI_APPLICATION = 'white_morning_dev_100677.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_morning_dev_100677 API",
    "DESCRIPTION": "API documentation for white_morning_dev_100677 App",
    "VERSION": "v1",
}
